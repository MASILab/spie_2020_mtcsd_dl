...
from data_gens.data_generator_smt_simple import nifti_smt_generator_simple
from data_gens.test_gen_smt_simple import test_smt_simple_predictor
from models.smt_models import build_smt_resnet_fracvol
...
def main():
    ...
    parser.add_argument('--data_list', '-d', required=False, type=str,
                        default=r'D:\Masi_data\SPIE_2020\Final_Data\data_list_pred_smt.json',
                        help='Data List file for training stored in a JSON format')

    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'D:\Masi_data\ISBI_2020\trained_resdnn_smt_final_data',
    ...
    parser.add_argument('--prior_weights', required=False, type=str,
                        default=r'D:\Masi_data\ISBI_2020\trained_resdnn_smt_final_data\weights-improvement-43-0.03.hdf5',
    ...
    # Build Model
    dl_model = build_smt_resnet_fracvol()
    ...
    if args.script_mode == "train":
        ...
        # Generators
        trainGen = nifti_smt_generator_simple(tr_data, bs=1000)
        validGen = nifti_smt_generator_simple(val_data, bs=1000)
        ...
        # Test Volumes
        test_smt_simple_predictor(dl_model=dl_model, test_data=test_data, save_path=model_base_path)
