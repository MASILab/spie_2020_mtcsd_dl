...
def main():
    ...
    parser.add_argument('--data_list', '-d', required=False, type=str,
                        default=r'D:\Masi_data\JUANDATA\data_list_final.json',
                        help='Data List file for training stored in a JSON format')

    parser.add_argument('--model_dir', '-m', required=False, type=str,
                        default=r'D:\Masi_data\JUANDATA\trained_patchcnn_volfrac_model',
    ...
    parser.add_argument('--prior_weights', required=False, type=str,
                        default=r'D:\Masi_data\SPIE_2020\trained_patchcnn_volfrac_model_all\weights-improvement-40-0.00.hdf5',
    ...
    # Build Model
    dl_model = build_sh_patch_resnet_fracvol()
    ...
    if args.script_mode == "train":
        ...
        # Generators
        trainGen = nifti_image_volfrac_generator_patch(tr_data, bs=1000, patch_size=patch_crop)
        validGen = nifti_image_volfrac_generator_patch(val_data, bs=1000, patch_size=patch_crop)
        ...
        # Test Volumes
        test_fracvol_patch_predictor_with_acc_v2(dl_model=dl_model, test_data=ad_data, save_path=model_base_path)
