...
def test_smt_patch_predictor(dl_model, test_data, save_path):
    ...
    for vol_index, each_vol in enumerate(test_data):
        ...
        batch_collector = np.zeros((batch_size, 3, 3, 3, 3))
        ...
        save_nifti(pred_vol, each_vol['input_image'], vol_saver_path)
